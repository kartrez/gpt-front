import{_ as ge}from"./DjB3JWXZ.js";import{_ as he,z as fe,x as ye,s as ve,C as be,o as _e,l as u,g as o,e as k,r,a as n,f as i,m as O,b as t,c as d,u as L,h as s,t as l,F as b,i as _,p as xe,R as w}from"./DgZ0-1fu.js";import{u as ke}from"./7xddnHdm.js";const we={class:"d-flex flex-column flex-md-row align-md-center ga-4"},Te={class:"flex-shrink-0"},Ae={class:"text-body-1 mb-3"},qe={class:"code-block position-relative"},ze={class:"code-block position-relative"},Ce={class:"d-flex flex-wrap ga-1"},Pe={class:"code-block position-relative"},Ie={class:"d-flex flex-wrap mb-3 ga-1"},Re={class:"d-flex flex-wrap mb-3 ga-1"},je={class:"d-flex flex-wrap ga-1"},Oe={class:"code-block position-relative"},Se={class:"d-flex flex-wrap ga-1"},Ee={class:"code-block position-relative"},Le={class:"d-flex flex-wrap align-center mb-3 ga-2"},Ke={class:"endpoint-url"},Ue={class:"text-subtitle-1 font-weight-medium mb-1"},Ge={class:"text-body-2 text-medium-emphasis mb-4"},$e={class:"d-flex align-center mb-2 ga-2"},Be={"data-label":"Параметр"},Ye={"data-label":"Тип"},He={class:"text-body-2 text-medium-emphasis"},Ne={"data-label":"Обязательный"},De={key:2,class:"text-caption text-medium-emphasis"},Je={"data-label":"По умолчанию"},Ve={key:0},Fe={key:1,class:"text-caption text-medium-emphasis"},Me={"data-label":"Описание",class:"text-body-2"},We={key:1,class:"text-body-2 text-medium-emphasis mb-4"},Qe={class:"code-block position-relative"},Ze={class:"toc-sticky position-sticky overflow-y-auto pl-4"},Xe={__name:"doc-api",setup(et){fe({title:"API документация - GPT-Chat",description:"Документация API GPT-Chat. Информация о доступе к API, эндпоинтах, форматах запросов и ответов для интеграции с нашими сервисами.",keywords:"API, документация, интеграция, эндпоинты, разработка, GPT-Chat API",robots:"index, follow"});const Q=ye(),Z=ke(),X=xe(()=>Z.value&&Q.loggedIn),{mobile:K}=ve(),q=k("text"),U=k("curl"),G=k("curl"),$=k("curl"),B=k("curl"),m=k(null),Y=k(null),ee=["google/gemini-3-flash","google/gemini-3.1-pro","google/gemini-3.5-flash","qwen/plus-3.7","anthropic/claude-sonnet-5","openai/gpt-5.6-sol"],te=["google/gemini-2.5-flash-image","google/gemini-3-flash-image","google/gemini-3.1-flash-image-preview","openai/gpt-5.4-image-2"],ae=[{ratio:"1:1",size:"1024×1024"},{ratio:"2:3",size:"832×1248"},{ratio:"3:2",size:"1248×832"},{ratio:"3:4",size:"864×1184"},{ratio:"4:3",size:"1184×864"},{ratio:"4:5",size:"896×1152"},{ratio:"5:4",size:"1152×896"},{ratio:"9:16",size:"768×1344"},{ratio:"16:9",size:"1344×768"},{ratio:"21:9",size:"1536×672"}],ie=[{size:"1K",label:"стандарт"},{size:"2K",label:"высокое"},{size:"4K",label:"максимум"}],oe=["qwen/plus-3.7","qwen/qwen3.7-max","google/gemini-3-flash","deepseek/deepseek-v4-pro","anthropic/claude-sonnet-5","openai/gpt-5.6-terra"],h={text:{curl:`curl https://api.gpt-chat.by/api/chat/completions \\
