import{_ as he}from"./BqzFJI-l.js";import{D as Q}from"./BozHYTMY.js";import{_ as fe,u as ye,C as ve,z as be,H as _e,i as xe,c as u,w as o,k,r,o as n,e as i,p as O,b as t,g as d,q as L,f as s,t as l,F as b,h as _,s as ke,S as w}from"./DUnXxUz-.js";import{u as we}from"./D9rU1KCx.js";const Te={class:"d-flex flex-column flex-md-row align-md-center ga-4"},Ae={class:"flex-shrink-0"},qe={class:"text-body-1 mb-3"},ze={class:"code-block position-relative"},Ce={class:"code-block position-relative"},Pe={class:"d-flex flex-wrap ga-1"},Ie={class:"code-block position-relative"},je={class:"d-flex flex-wrap mb-3 ga-1"},Re={class:"d-flex flex-wrap mb-3 ga-1"},Oe={class:"d-flex flex-wrap ga-1"},Se={class:"code-block position-relative"},Ee={class:"d-flex flex-wrap ga-1"},Le={class:"code-block position-relative"},Ue={class:"d-flex flex-wrap align-center mb-3 ga-2"},Ke={class:"endpoint-url"},Ge={class:"text-subtitle-1 font-weight-medium mb-1"},$e={class:"text-body-2 text-medium-emphasis mb-4"},Be={class:"d-flex align-center mb-2 ga-2"},Ye={"data-label":"Параметр"},Ne={"data-label":"Тип"},He={class:"text-body-2 text-medium-emphasis"},De={"data-label":"Обязательный"},Je={key:2,class:"text-caption text-medium-emphasis"},Ve={"data-label":"По умолчанию"},Me={key:0},Fe={key:1,class:"text-caption text-medium-emphasis"},We={"data-label":"Описание",class:"text-body-2"},Qe={key:1,class:"text-body-2 text-medium-emphasis mb-4"},Ze={class:"code-block position-relative"},Xe={class:"toc-sticky position-sticky overflow-y-auto pl-4"},et={__name:"doc-api",setup(tt){ye({title:"API документация - GPT-Chat",description:"Документация API GPT-Chat. Информация о доступе к API, эндпоинтах, форматах запросов и ответов для интеграции с нашими сервисами.",keywords:"API, документация, интеграция, эндпоинты, разработка, GPT-Chat API",robots:"index, follow"});const Z=ve(),X=we(),ee=ke(()=>X.value&&Z.loggedIn),{mobile:U}=be(),q=k("text"),K=k("curl"),G=k("curl"),$=k("curl"),B=k("curl"),m=k(null),Y=k(null),te=["google/gemini-3-flash","google/gemini-3.1-pro","google/gemini-3.5-flash","qwen/plus-3.7","anthropic/claude-sonnet-5","openai/gpt-5.6-sol"],ae=["google/gemini-2.5-flash-image","google/gemini-3-flash-image","google/gemini-3.1-flash-image-preview","openai/gpt-5.4-image-2"],ie=[{ratio:"1:1",size:"1024×1024"},{ratio:"2:3",size:"832×1248"},{ratio:"3:2",size:"1248×832"},{ratio:"3:4",size:"864×1184"},{ratio:"4:3",size:"1184×864"},{ratio:"4:5",size:"896×1152"},{ratio:"5:4",size:"1152×896"},{ratio:"9:16",size:"768×1344"},{ratio:"16:9",size:"1344×768"},{ratio:"21:9",size:"1536×672"}],oe=[{size:"1K",label:"стандарт"},{size:"2K",label:"высокое"},{size:"4K",label:"максимум"}],se=["qwen/plus-3.7","qwen/qwen3.7-max","google/gemini-3-flash","deepseek/deepseek-v4-pro","anthropic/claude-sonnet-5","openai/gpt-5.6-terra"],h={text:{curl:`curl https://api.gpt-chat.by/api/chat/completions \\
